...
!function ($) {
    ...
    var Page = function (element, options) {
        ...
        this.$page = $('<ul class="m-pagination-page pagination"></ul>');
        ...
        var init = function (obj) {
            ...
            //init jump module
            var jumpHtml = '<div class="m-pagination-group input-group input-group-sm"><input class="form-control" type="text"><span class="input-group-btn"><button data-page-btn="jump" class="btn btn-default" type="button">' + that.options.jumpBtnText + '</button></span></div>';
    ...
    Page.prototype = {
        ...
        renderPerPage: function (text, value) {
            var $pageBtn = $("<li class='pagination-btn'><a data-page-index='" + value + "'>" + text + "</a></li>");
            return $pageBtn;
        },
